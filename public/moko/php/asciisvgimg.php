...
//
// Requires GD2 and Freetype for full functionality
//
...
function AStoIMG($w=200, $h=200) {
	...
	$gdi = gd_info();
	$this->usettf = ($gdi["FreeType Support"] && strpos($gdi["GD Version"],'(2.')!==false);
	$this->usegd2 =  strpos($gdi["GD Version"],'(2.')!==false;
