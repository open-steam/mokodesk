LarsHtmlMessageWindow = function(node) {
    this.node = node;
    ...
    LarsHtmlMessageWindow.superclass.constructor.call(this, {
        title: Lars.dialog.htmlMessage.title,
        ...
        autoScroll: true,
        buttons:[{
            text: Lars.dialog.htmlMessage.button_create,
            handler: this.onAdd,
            scope: this
        },{
...
Ext.extend(LarsHtmlMessageWindow, Ext.Window, {
